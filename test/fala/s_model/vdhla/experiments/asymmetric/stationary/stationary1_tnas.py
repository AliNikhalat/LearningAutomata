...
action_number = 2
state_number_1 = [1 for _ in range(action_number)]
state_number_4 = [4 for _ in range(action_number)]
state_number_6 = [4 for _ in range(action_number)]
reward_rate = 0.1
penalty_rate = 0.01
...
a_vdhla_1 = AsymmetricVariableDepthHybrid(
    action_number, state_number_1, reward_rate, penalty_rate)
a_vdhla_4 = AsymmetricVariableDepthHybrid(
    action_number, state_number_4, reward_rate, penalty_rate)
a_vdhla_6 = AsymmetricVariableDepthHybrid(
    action_number, state_number_6, reward_rate, penalty_rate)
...
for i in range(iteration_number):
    ...
    chosen_action_vdhla_4 = 0
    if i != 0:
        chosen_action_vdhla_4 = a_vdhla_4.choose_action()
    else:
        chosen_action_vdhla_4 = a_vdhla_4.choose_random_action()

    evaluated_action_vdhla_4 = environment.evaluate_action(
        chosen_action_vdhla_4)
    a_vdhla_4.receive_environment_signal(evaluated_action_vdhla_4)

    # Symmetric VDHLA Tests --> N=6
    chosen_action_vdhla_6 = 0
    if i != 0:
        chosen_action_vdhla_6 = a_vdhla_6.choose_action()
    else:
        chosen_action_vdhla_6 = a_vdhla_6.choose_random_action()

    evaluated_action_vdhla_6 = environment.evaluate_action(
        chosen_action_vdhla_6)
    a_vdhla_6.receive_environment_signal(evaluated_action_vdhla_6)
...
plt.plot(x_values, a_vdhla_1.get_total_number_of_action_switching,
         color='r', label='Asymmetric VDHLA(N=1)', linestyle='dashed')
plt.plot(x_values, a_vdhla_4.get_total_number_of_action_switching,
         color='g', label='Asymmetric VDHLA(N=4)', linestyle='dashed')
plt.plot(x_values, a_vdhla_6.get_total_number_of_action_switching,
         color='purple', label='Asymmetric VDHLA(N=6)', linestyle='dashed')
plt.plot(x_values, pure_chance_automata.get_total_number_of_action_switching,
