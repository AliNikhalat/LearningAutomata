...
plt.plot(x_values, a_vdhla_1.get_total_number_of_rewards,
         color='r', label='Asymmetric VDHLA(N=1)', linestyle='dashed')
plt.plot(x_values, a_vdhla_4.get_total_number_of_rewards,
         color='g', label='Asymmetric VDHLA(N=4)', linestyle='dashed')
plt.plot(x_values, a_vdhla_6.get_total_number_of_rewards,
