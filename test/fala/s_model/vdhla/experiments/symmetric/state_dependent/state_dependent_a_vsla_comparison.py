...
for i in range(iteration_number):
    ...
    if i != 0:
        chosen_action_vdhla = s_vdhla5.choose_action()
    else:
        chosen_action_vdhla = s_vdhla5.choose_random_action()

    evaluated_action_vdhla_2 = environment_1.evaluate_action(
        chosen_action_vdhla)
    s_vdhla5.receive_environment_signal(evaluated_action_vdhla_2)
