...
for i in range(iteration_number):
    ...
    depth_calculation.append(s_vdhla_1.fsla_state_number)

# Plots
x_values = [i for i in range(iteration_number)]

plt.plot(x_values, s_vdhla_1.get_total_number_of_action_switching,
         color='r', label='Symmetric VDHLA(N=1)', linestyle='dashed')
plt.plot(x_values, s_vdhla_4.get_total_number_of_action_switching,
         color='g', label='Symmetric VDHLA(N=4)', linestyle='dashed')
plt.plot(x_values, s_vdhla_6.get_total_number_of_action_switching,
